  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-blue-50 to-cyan-50 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className={"container max-w-6xl mx-auto transition-all duration-700 ease-out transform " + (mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8") }>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center space-y-8 text-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-slate-600 max-w-md">{t("login.welcome")}</p>
            ...
            <div className="w-full max-w-md mx-auto lg:mx-0">
              <Card className="backdrop-blur-xl bg-white/90 shadow-2xl border-0 rounded-3xl overflow-hidden">
                ...
                <CardHeader className="relative z-10 pb-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-slate-600 mt-1">{t("login.welcome")}</CardDescription>
                    </div>
                  </div>
                ...
                <CardContent className="relative z-10 space-y-6">
                  <form onSubmit={onSubmit} className="space-y-6" aria-describedby="login-errors">
                    {!mfaPending ? (
                    <>
                    {/* Email Field */}
                    <div className="space-y-2">
                      <label htmlFor={idIdentifier} className="text-sm font-medium text-slate-700 block">
                        {t("login.email")}
                      </label>
                      ...
                      {identifierError && (
                        <div id="identifier-error" role="alert" aria-live="assertive" className="text-sm text-red-600 flex items-center gap-2 animate-in slide-in-from-left-2 duration-300">
                    ...
                    {/* Password Field */}
                    <div className="space-y-2">
                      <label htmlFor={idPassword} className="text-sm font-medium text-slate-700 block">
                        {t("login.password")}
                      </label>
                      <div className="relative group">
                        <Input
                      ...
                      {passwordError && (
                        <div id="password-error" role="alert" aria-live="assertive" className="text-sm text-red-600 flex items-center gap-2 animate-in slide-in-from-left-2 duration-300">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <circle cx="12" cy="12" r="10"></circle>
                            <line x1="15" y1="9" x2="9" y2="15"></line>
                            <line x1="9" y1="9" x2="15" y2="15"></line>
                    ...
                    <div className="flex items-center justify-between">
                      <label className="flex items-center gap-3 cursor-pointer group">
                        <Checkbox checked={remember} onCheckedChange={(v)=>setRemember(!!v)} className="data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600" />
                        <span className="text-sm text-slate-600 group-hover:text-slate-800 transition-colors">{t("login.remember")}</span>
                      </label>
                      <button type="button" className="text-sm text-blue-600 hover:text-blue-700 hover:underline transition-all duration-200 font-medium" onClick={onForgot}>
                        {t("login.forgot")}
                      </button>
                    </div>
                    ...
                    <div className="pt-2">
                      ...
                      <div className="space-y-6 animate-in fade-in duration-500">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-slate-600">Enter the OTP sent to your registered contact.</p>
                        </div>
                        ...
                        <div className="flex gap-3">
                          <Button onClick={submitMfa} className="flex-1 h-12 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold rounded-xl">
                            Verify & Continue
                          </Button>
                          <Button variant="outline" onClick={()=>{ setMfaPending(false); setMfaUserId(null); }} className="h-12 border-2 hover:bg-slate-50 rounded-xl">
                            {t("cancel")}
                          </Button>
                        </div>
                      </div>
