  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex gap-2">
          <Button asChild>
            <a href="/admin/access-control">
              <Users className="ml-2" /> {t("pages.admin.buttons.accessControl")}
            </a>
          </Button>
          <Button>
            <FileChartColumn className="ml-2" /> {t("pages.admin.buttons.exportReport")}
          </Button>
      ...
      <section className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader>
            <CardDescription>{t("pages.admin.tiles.beneficiaries.title")}</CardDescription>
            <CardTitle className="flex items-baseline gap-2">
              1,248{" "}
              <Badge variant="secondary">{t("pages.admin.tiles.beneficiaries.deltaToday")}</Badge>
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardDescription>{t("pages.admin.tiles.appointments.title")}</CardDescription>
        ...
        <Card>
          <CardHeader>
            <CardDescription>{t("pages.admin.tiles.staffUtil.title")}</CardDescription>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">{t("pages.admin.tiles.staffUtil.note")}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <CardDescription>{t("pages.admin.tiles.quality.title")}</CardDescription>
            <CardTitle className="flex items-center gap-2">
              96% <Activity className="h-5 w-5 text-success" />
            </CardTitle>
          </CardHeader>
          <CardContent className="text-sm text-muted-foreground">{t("pages.admin.tiles.quality.desc")}</CardContent>
        </Card>
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-6">
              <div>
                <p className="text-sm text-muted-foreground">{t("pages.admin.chart.labels.residential")}</p>
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("pages.admin.chart.labels.daycare")}</p>
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("pages.admin.chart.labels.home")}</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <AlertTriangle className="text-warning" /> {t("pages.admin.alerts.title")}
            </CardTitle>
          ...
          <CardContent>
            <ul className="space-y-3 text-sm">
              <li className="flex items-center justify-between">
                ...
                <span className="rounded bg-warning/15 text-warning px-2 py-0.5">{t("pages.admin.alerts.levels.high")}</span>
              </li>
              <li className="flex items-center justify-between">
                <span>{t("pages.admin.alerts.items.transportDelay")}</span>
                <span className="rounded bg-warning/15 text-warning px-2 py-0.5">{t("pages.admin.alerts.levels.medium")}</span>
              </li>
              <li className="flex items-center justify-between">
                <span>{t("pages.admin.alerts.items.therapyRescheduled")}</span>
                <span className="rounded bg-info/15 text-info px-2 py-0.5">{t("pages.admin.alerts.levels.info")}</span>
              </li>
            </ul>
          </CardContent>
        </Card>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="flex items-center gap-3 text-sm text-muted-foreground">
            <CalendarCheck className="h-4 w-4" /> {t("pages.admin.reviews.summary")}
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
