  ...
  ar: {
    ...
    pages: {
      ...
      admin: {
        ...
        tiles: {
          beneficiaries: { title: "المس��فيدون", deltaToday: "+٢٤ اليوم" },
        ...
        team: { title: "أداء الفريق", desc: "الحضور والملاحظات وتقرير الحواد��.", summary: "٩٢٪ تسجيل حضور في الوقت · ١٨ زيارة ميدانية" },
    ...
    home: {
      ...
      portals: {
        ...
        desc: "بوابات المستفيد والموظف والإدارة وا��عائلة لتبسيط العمليات اليومية — التسجيل والسجلات والعلاجات والحضور والتواصل الآمن.",
        open: "فتح",
        beneficiary: {
