  ...
  ar: {
    ...
    pages: {
      ...
      accessControl: {
        ...
        subtitle: "إدارة المستخدمين والأدوار والصلاحيات؛ وتعيينها بأمان.",
    ...
    home: {
      ...
      portals: {
        ...
        desc: "بوابات المستفيد والموظف والإدارة والعائلة لتبسيط العم��يات اليومية — التسجيل والسجلات والعلاجات والحضور والتواصل الآمن.",
        open: "فتح",
        beneficiary: {
      ...
      security: {
        ...
        desc: "أمان متقدم مع تشفير البيانات والمصادقة الثنائية وسجلات التدقيق وإمكانية الوصول الكاملة. جاهز للسحاب�� وقابل للتوسع مع تكاملات للأنظمة الوطنية والأجهزة الطبية.",
        features: {
          advanced: {
            title: "أمان متقدم",
